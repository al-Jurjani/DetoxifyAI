...
# Optional: If your dataset has a target column, configure ColumnMapping
# from evidently.options import ColumnMapping
# column_mapping = ColumnMapping()
# column_mapping.target = 'label'  # Replace with actual target column
# report.run(reference_data=train_data, current_data=test_data, column_mapping=column_mapping)

# Run drift detection (no mapping if no target)
try:
